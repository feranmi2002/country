...
import com.faithdeveloper.country.adapters.CountryPropertiesAdapter
import com.faithdeveloper.country.adapters.ImagesAdapter
import com.faithdeveloper.country.databinding.DetailsScreenBinding
...
class DetailsFragment : Fragment() {
    ...
    private fun setUpPropertiesAdapter() {
        propertiesAdapter = CountryPropertiesAdapter(
            Utils.formatCountryProperties(data, resources.getStringArray(R.array.country_abbreviations), resources.getStringArray(R.array.countries)),
