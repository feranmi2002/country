package com.faithdeveloper.country.viewmodels
...
import com.faithdeveloper.country.paging.ExplorePagingSource
import com.faithdeveloper.country.retrofit.ApiHelper
import com.faithdeveloper.country.util.Utils.ALL_COUNTRIES_QUERY_TYPE
...
class ExploreViewModel(private val apiHelper: ApiHelper) : ViewModel(),
    ViewModel_PagingSource_Interface {
    ...
    private fun request(query: String?, queryType: String) =
        Pager(
